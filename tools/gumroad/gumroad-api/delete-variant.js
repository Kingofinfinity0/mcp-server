/**
 * Function to delete a variant from a product's variant category on Gumroad.
 *
 ...
 * @param {string} args.id - The ID of the variant to delete.
...
/**
 * Tool configuration for deleting a variant from a product's variant category on Gumroad.
 * @type {Object}
 */
const apiTool = {
  ...
  definition: {
    ...
    function: {
      name: 'delete_variant',
      description: 'Delete a variant from a product\'s variant category on Gumroad.',
      parameters: {
        type: 'object',
        properties: {
          product_id: {
